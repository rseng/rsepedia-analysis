...
[^ChambollePock2011]:
    ...
    > doi: [10.1007/s10851-010-0251-1](https://dx.doi.org/10.1007/s10851-010-0251-1)# [Particle Swarm Optimization](@id ParticleSwarmSolver)
...
## Literature# [The Riemannian Trust-Regions Solver](@id trust_regions)
...
as [JacobiFields](@ref JacobiFieldFunctions) (e.g. easily to evaluate for symmetric manifolds).# [Proximal Maps](@id proximalMapFunctions)
...
## Literature# [Gradients](@id GradientFunctions)
