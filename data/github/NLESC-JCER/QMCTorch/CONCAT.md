...
By default the inverse kernel will be used. Orbital dependent backflow orbitals can be easily achieved by using ``orbital_dependent_backflow=True``FermiNet Wave Function
----------------------------------------Solvers
=========================
...
>>> plot_data(solver.observable, obsname='jastrow.weight')Optimizers
===========================
...
.. image:: ../../pics/h2_dzp.pngGeometry Optimization
====================================
...
model has been greatly succesfull in machine learning applications (http://jmlr.org/papers/volume20/18-789/18-789.pdf)Exploring the results with h5x
=====================================
...
.. image:: ../pics/h5x_solver.PNGGPU support
==============================================

.. literalinclude:: ../../example/gpu/h2.pyMulti-GPU support
==============================================

.. literalinclude:: ../../example/horovod/h2.pySingle point calculation
==============================================
