...
.. literalinclude:: ../../example/gpu/h2.pyWave function optimization
==============================================

.. literalinclude:: ../../example/optimization/h2.pySingle point calculation
==============================================

.. literalinclude:: ../../example/single_point/h2o_sampling.pyMulti-GPU support
==============================================

.. literalinclude:: ../../example/horovod/h2.pySlater Jastrow Wave Function
-----------------------------------
...
By default the inverse kernel will be used. Orbital dependent backflow orbitals can be easily achieved by using ``orbital_dependent_backflow=True``Pauli Net Wave Function
----------------------------------------Solvers
=========================
...
.. image:: ../pics/h5x_solver.PNGSingle point and Sampling trajectory
========================================
...
.. image:: ../../pics/h2_dzp.pngCreating your own Jastrow Factor
====================================
...
As previously, `mol` is an instance of the `qmctorch.scf.Molecule` class.GPUs and multi-GPUs Support
==============================================
