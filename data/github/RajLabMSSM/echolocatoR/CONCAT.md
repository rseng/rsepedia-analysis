...
\usage{
SUMMARISE.get_CS_bins(merged_DT)
}
\description{
...
\usage{
SUMMARISE.get_CS_counts(merged_DT, top_CS_only = F)
}
\description{
...
\keyword{internal}
% Generated by roxygen2: do not edit by hand
% Please edit documentation in R/startup_image.R
\name{startup_image}
\alias{startup_image}
\title{Print the echolocatoR image to the R console.}
\usage{
startup_image()
}
\description{
...
\usage{
order_loci(dat, merged_DT, by_UCS_size = F, descending = T, verbose = F)
}
\description{
...
\usage{
SUMMARISE.CS_bin_plot(merged_DT, show_plot = T)
}
\description{
Plot CS bin counts
}
...
\usage{
SUMMARISE.get_SNPgroup_counts(merged_DT, grouping_vars = "Locus")
}
\description{
...
\usage{
ANNOTATE.annotate_missense(merged_DT, snp_filter = "Support>0")
}
\description{
