...
with the code, the pull request will be merged.  Congratulations on a succesful contribution![![GH Actions Status](https://github.com/openmm/openmm/workflows/CI/badge.svg)](https://github.com/openmm/openmm/actions?query=branch%3Amaster+workflow%3ACI)
...
:ref:`_compiling-openmm-from-source-linux`.. _platform-specific-properties:
