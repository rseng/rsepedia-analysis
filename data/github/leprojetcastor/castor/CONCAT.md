...
See :ref:`label-idft`, :ref:`label-fft`... _label-builders:
...
https://www.ljll.math.upmc.fr/ledret/M1English/M1ApproxPDE_Chapter6-2.pdf.. _label-operators:
...
See :ref:`label-operator+`, :ref:`label-operator-`, :ref:`label-operator*`... _label-matrix-manipulations:
...
Please note that this code is part of the ``overview_kissfft.cpp`` file which can be found in the ``demo/demo_kissfft`` subfolder... _label-basic:
...
http://www.vergenet.net/~conrad/boids/pseudocode.htmlGetting started
===============
...
http://www.cmap.polytechnique.fr/~jingrebeccali/frenchvietnammaster2_files/2017/LectureNotes/pde3d_mit.pdf.. _label-input-output:
...
See :ref:`label-readtxt`, :ref:`label-writebin`... _label-mathematical-functions:
...
See :ref:`label-atanh`... _label-installation:
...
The project can be found `here <https://github.com/marcbakry/AnalyticalScattering/>`_... role:: red
...
---
.. doxygenfunction:: spy
    :project: castorReplicator mutator equation
===========================
...
https://en.wikipedia.org/wiki/Monte_Carlo_method.. _label-castorfftw:
...
|
| http://www.unige.ch/~hairer/poly/chap3.pdf.. _label-mesh-management:
...
See :ref:`label-sphere`... _label-graphical-tools:
