...
See :ref:`label-operator+`, :ref:`label-operator-`, :ref:`label-operator*`... _label-mathematical-functions:
...
See :ref:`label-atanh`... _label-mesh-management:
...
**Castor FFTW** is the **castor** wrapper for the well-known FFTW3 library. The *git* repository can be found `here <https://github.com/marcbakry/castor-fftw>`_ and the documentation at `https://marcbakry.github.io/castor-fftw/ <https://marcbakry.github.io/castor-fftw/>`_.Getting started
===============
...
See :ref:`label-sphere`... _label-transforms:
...
https://en.wikipedia.org/wiki/Monte_Carlo_method.. _label-using-kissfft:
...
Please note that this code is part of the ``overview_kissfft.cpp`` file which can be found in the ``demo/demo_kissfft`` subfolder.Welcome to the castor library documentation
===========================================
...
---
.. doxygenfunction:: spy
    :project: castor.. _label-matrix-dimensions:
...
http://www.cmap.polytechnique.fr/~jingrebeccali/frenchvietnammaster2_files/2017/LectureNotes/pde3d_mit.pdf.. _label-advanced:
...
The project can be found `here <https://github.com/marcbakry/AnalyticalScattering/>`_... _label-installation:
...
https://www.ljll.math.upmc.fr/ledret/M1English/M1ApproxPDE_Chapter6-2.pdf.. _label-mesh-plot:
