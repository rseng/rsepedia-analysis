...
_Thank you for contributing to Magritte!_<img src="docs/src/images/Magritte_logo_plain.svg" alt="logo" width="350"/>
...
TC is a PhD fellow of the Research Foundation - Flanders (FWO).# Dependencies

Some installers for dependencies.
# magritte

This directory contains the Magritte python package.# Models
...
FDC, JB, WH, and LD acknowledge support from the ERC consolidator grant 646758 AEROSOL.
TC is a PhD fellow of the Research Foundation - Flanders (FWO).Numeric benchmarks
##################
...
.. toctree::
   ...
   6_image_3D_Phantom_red.ipynb.. _link-post-processing:
