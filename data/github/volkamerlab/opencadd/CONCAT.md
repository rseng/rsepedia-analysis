...
be inside a directory called `html/` depending on what version of Sphinx is installed).# Exploratory notebooks
...
This list of minimal supported versions is based on `this CI run <https://github.com/volkamerlab/opencadd/runs/4462667598?check_suite_focus=true#step:6:42>`_.Installing OpenCADD-KLIFS only
==============================
