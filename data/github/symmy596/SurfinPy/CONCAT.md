...
Ideally pull requests will respect the underlying intrastructure of surfinpy and agree with PEP8, etc. However, please do not let this put novice programmers off contributing as we will do everything we can to help. All notable changes to this project will be documented in the file.
...
[version]: http://contributor-covenant.org/version/1/4/# SurfinPy
...
In the Scripts/ you will find the tutorials but in python script format. surfinpy\.vibrational_data
==========================

.. automodule:: surfinpy.vibrational_data
    :members:
    :undoc-members:
    :show-inheritance:Pressure vs Temperature
=======================
...
- `Thermodynamic Evolution of Cerium Oxide Nanoparticle Morphology Using Carbon Dioxide <https://pubs.acs.org/doi/abs/10.1021/acs.jpcc.0c07437>`__ surfinpy\.p_vs_t
================
...
.. automodule:: surfinpy.mu_vs_mu
    :members:
    :undoc-members:
    :show-inheritance:Vibrational Theory
==================
