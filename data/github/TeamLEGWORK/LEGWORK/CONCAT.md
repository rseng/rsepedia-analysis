...
More citation methods are `available on ADS <https://ui.adsabs.harvard.edu/abs/2021arXiv211108717W/exportcitation>`__ if you'd rather use a different format!Demos
=====
...
.. tabs::
    ...
    .. tab:: Development (from GitHub)
        ...
        and you should be all set! Check out our `quickstart tutorial <notebooks/Quickstart.ipynb>`__ to learn some LEGWORK basics.
        Note that if you also want to work with the notebooks in the tutorials and/or demos you'll also need to install jupyter/ipython in this environment!Scope and Limitations
=====================
