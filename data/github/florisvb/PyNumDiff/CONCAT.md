...
.. toctree::
   ...
   finite_difference/_finite_differenceutils
=====
...
.. toctree::
   ...
   utils/evaluate
   utils/simulate
   utils/utilityHow to contribute
===================
...
Submitting a patch:
  ...
  6. Finally, push the commits to your fork and submit a pull request. Please, remember to rebase properly in order to maintain a clean, linear git history.kalman_smooth
=============

.. toctree::
   :maxdepth: 1

   kalman_smooth/_kalman_smoothPyNumDiff
=========
...
.. toctree::
   ...
   contact
   contributing
   LICENSEtotal_variation_regularization
==============================

.. toctree::
   :maxdepth: 1

   total_variation_regularization/_total_variation_regularizationlinear_model
============

.. toctree::
   :maxdepth: 1

   linear_model/_linear_modelAPI documentation
============================
...
.. toctree::
   ...
   smooth_finite_difference/_smooth_finite_differenceoptimize
=========
...
- Yuying Liu: liuyuyingufo@gmail.com_smooth_finite_difference
===========================
