...
### Added
- Initial release. Fonts available: Cairo (Arabic), Noto Sans JP (Japanese), Noto Sans KR (Korean), Noto Sans SC (Simplified Chinese), Noto Sans TC (Traditional Chinese), Open Sans (Cyrilic), Rubik (Hebrew), Sarabun (Thai).## amCharts 4 PDF fonts
...
Open an [issue](https://github.com/amcharts/amcharts4/issues).# amCharts 4 Changelog
...
Open an [issue](https://github.com/amcharts/amcharts4/issues).Steps to use
============

1. Open `index.html` in a browserSteps to use
============
